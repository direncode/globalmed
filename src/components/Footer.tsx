      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold tracking-tight">GlobeMed</span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/our-partner" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Our Partner
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <p className="text-gray-500 text-sm text-center">
            &copy; {new Date().getFullYear()} GlobeMed at UNC-Chapel Hill. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
